  ...
  return (
    <article className="min-h-screen bg-bg-deep">
      ...
      <section className="mx-auto flex max-w-7xl flex-col gap-7 px-5 py-16 sm:px-8 md:flex-row md:items-center md:justify-between lg:px-12 lg:py-20">
        ...
        <Link href="/contact" prefetch={false} className="inline-flex shrink-0 items-center gap-3 rounded-sm border border-text-primary px-5 py-3 font-mono text-[11px] uppercase tracking-[0.18em] text-text-primary transition-[background-color,border-color,color,transform] duration-medium ease-out-quart hover:bg-text-primary hover:text-bg-deep active:translate-y-px focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg-deep">
          Start a conversation <ArrowRight size={15} aria-hidden="true" />
        </Link>
      </section>

      <div className="mx-auto max-w-7xl px-5 pb-12 sm:px-8 lg:px-12">
        <Link href="/investment" prefetch={false} className="inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.18em] text-text-tertiary transition-colors duration-fast hover:text-text-primary">
